...
<template>
  <form class="d-flex align-center gap-2 pa-4" @submit.prevent="addItemAndClear(msg)">
    <v-btn icon variant="text"><MoodSmileIcon size="20" /></v-btn>

    <v-text-field variant="outlined" hide-details v-model="msg" color="primary" label="Type een bericht..."></v-text-field>
